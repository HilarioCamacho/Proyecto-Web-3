<?php 
    ...
    $registro->registroCatalogoPrincipal();
    $registro->eliminarCatalogoPrincipal();

    if (isset($_GET["action"])) {
      if ($_GET["action"] == "OK_CP") {
        ?>
...
<section class="content-header">
  ...
  <h1>
    Catalogos Generales
    <small>Control de catalogos Generales</small>
  </h1>

  <ol class="breadcrumb">
    <li><a href="index.php?action=inicio"><i class="fa fa-dashboard"></i>Inicio</a></li>
    <li class="active">Catalogos Generales</li>
  </ol>
...
<section class="content">
  ...
  <div class="box box-danger">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">Catalogos Generales</h3>
    ...
    <div class="box-body">
      <!-- VISTA PRINCIPAL CATALOGO GENERAL -->
      ...
      <div class="modal modal-info fade" id="cpRegistro">
          ...
          <form class="p-1" method="POST">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Registro Catalogo General</h4>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="registro_catalogoP" class="btn btn-outline text-light" style="background-color: #ff791e;">Registrar</button>
              </div>
            </div>
            </form>
            <!-- /.modal-content -->
